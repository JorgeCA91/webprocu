...
<?php echo $this->Form->create('Reporte'); ?>
	<fieldset>
		<legend><?php echo __('Administrador Edit Reporte'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Reporte.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Reporte.id'))); ?></li>
