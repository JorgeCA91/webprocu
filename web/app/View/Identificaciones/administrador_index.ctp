<div class="identificaciones index">
	<h2><?php echo __('Identificaciones'); ?></h2>
	...
	<?php foreach ($identificaciones as $identificacion): ?>
	<tr>
		<td><?php echo h($identificacion['Identificacion']['id']); ?>&nbsp;</td>
		<td><?php echo h($identificacion['Identificacion']['tipo']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $identificacion['Identificacion']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $identificacion['Identificacion']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $identificacion['Identificacion']['id']), null, __('Are you sure you want to delete # %s?', $identificacion['Identificacion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
